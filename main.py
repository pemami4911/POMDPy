...
if __name__ == '__main__':
    ...
    parser.add_argument('--solver', type=str,
                        help='Specify the solver to use {POMCP|SARSA|ValueIteration|LinearAlphaNet|VI-Baseline}')
    ...
    if args['solver'] == 'VI-Baseline':
        ...
        #print('Running classic VI agent with planning horizon of 8...')
        #approximate_vi_eval.eval_baseline(args['n_epochs'], agent, 8)
        #print('Running classic VI agent with planning horizon of 1...')
        ...
        if args['env'] == 'RockSample':
            if not (args['solver'] == 'SARSA' or args['solver'] == 'POMCP'):
            ...
            if not (args['solver'] == 'ValueIteration' or
                    args['solver'] == 'LinearAlphaNet'):
